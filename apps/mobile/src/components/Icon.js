...
const ICONS = {
  ...
  // Auricular colgado (llamada terminada): el mismo trazo, girado boca abajo.
  callEnd: [['p', 'M3.6 13.2c4.8-4.6 12-4.6 16.8 0l-1.9 2.3-3.3-1.2-.3-2.5a9.2 9.2 0 0 0-5.8 0l-.3 2.5-3.3 1.2-1.9-2.3Z']],
  // Llamada con ondas: el auricular con dos arcos de voz.
  call: [['p', 'M6.2 4.2h2.6l1.3 3.3-1.8 1.3a9.8 9.8 0 0 0 5.3 5.3l1.3-1.8 3.3 1.3v2.6a1.9 1.9 0 0 1-2 1.9C10.3 17.6 5.2 12.5 4.3 6.2a1.9 1.9 0 0 1 1.9-2Z'], ['p', 'M14.5 6.2a4 4 0 0 1 3.3 3.3'], ['p', 'M14.8 2.9a7.3 7.3 0 0 1 6.3 6.3']],
